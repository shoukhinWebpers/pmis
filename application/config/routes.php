...
$route['pcmu_yearly_project_form']                           = 'forms/accounts/Yearly_project';
$route['pcmu_yearly_project_form_submit']                    = 'forms/accounts/Yearly_project/submit';
$route['pcmu_yearly_project_report/(:num)']                  = 'forms/accounts/Yearly_project/get_data/$1';
$route['ddm_yearly_project_form']                            = 'forms/accounts/Yearly_project';
$route['ddm_yearly_project_form_submit']                     = 'forms/accounts/Yearly_project/submit';
$route['ddm_yearly_project_report/(:num)']                   = 'forms/accounts/Yearly_project/get_data/$1';
$route['rajuk_yearly_project_form']                          = 'forms/accounts/Yearly_project';
$route['rajuk_yearly_project_form_submit']                   = 'forms/accounts/Yearly_project/submit';
$route['rajuk_yearly_project_report/(:num)']                 = 'forms/accounts/Yearly_project/get_data/$1';
$route['dncc_yearly_project_form']                           = 'forms/accounts/Yearly_project';
$route['dncc_yearly_project_form_submit']                    = 'forms/accounts/Yearly_project/submit';
$route['dncc_yearly_project_report/(:num)']                  = 'forms/accounts/Yearly_project/get_data/$1';
